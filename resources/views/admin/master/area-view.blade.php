        ...
        <section class="content">
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-user mr-1"></i> {{ $area->area_name }}
                    </h3>

                    <div class="card-tools">
                        <a href="{{ route('areas.index') }}" class="btn btn-sm btn-warning">
                    ...
                    <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content text-center">
                                            <span class="info-box-text text-muted">Area Code</span>
                                            <span class="info-box-number">{{ $area->area_code }}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {{-- <div class="col-md-4">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content text-center">
                                            ...
                                            <span class="info-box-number">{{ $area->area_phone }}</span>
                                        </div>
                                    </div>
                                </div> --}}
                                ...
                                <div class="col-md-4">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content text-center">
                                            ...
                                            <span class="badge badge-{{ $area->status ? 'success' : 'secondary' }}">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="text-muted">
                                <p class="text-sm">
                                    Added By
                                    <b class="d-block">{{ $area->addedBy->first_name ?? '-' }}
                                        {{ $area->addedBy->last_name ?? '' }}</b>
                                </p>

                                <p class="text-sm">
                                    Updated By
                                    <b class="d-block">{{ $area->updatedBy->first_name ?? '-' }}
                                        {{ $area->updatedBy->last_name ?? '' }}</b>
                                </p>
                                {{-- @dd($area->created_at) --}}
