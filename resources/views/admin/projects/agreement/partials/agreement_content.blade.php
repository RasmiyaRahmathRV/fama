            ...
            <td width="1025" colspan="6" bgcolor="#FFFFFF">
                <table width="100%" border="1" align="center">
                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <div align="center" class="text-sm text-sm">
                                <strong>{{ $agreement->contract->property->property_name }}</strong>
                            </div>
                        </td>
                        <td bgcolor="#FFFFFF">
                            <div align="center" class="text-sm text-sm">
                    ...
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF">
                            <div class="text-sm text-sm ml-1">
                                <strong>{{ number_format($rpa) }}</strong>
                            </div>
                        </td>
                        <td bgcolor="#FFFFFF">
                            <div align="center" class="text-sm text-sm">
                    ...
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF" colspan="3" width="41.9%">
                            <div class="text-sm text-sm ml-1">
                                <strong>{{ $unit->contractUnitDetail->unit_revenue }}</strong>
                            </div>
                        </td>
                        <td bgcolor="#FFFFFF" colspan="2">
                            <div align="center" class="text-sm text-sm">
                    ...
                    @foreach ($agreement->agreement_payment->agreementPaymentDetails->where('agreement_unit_id', $unit->id) as $index => $detail)
                        <tr>
                            <td width="15%" bgcolor="#FFFFFF">
                                <div align="center" class="text-sm text-sm">
                                    <strong> <span
                                            class="text-sm text-sm style14"></span>{{ \Carbon\Carbon::parse($detail->payment_date)->format('d-m-Y') }}</strong>
                                </div>
                            </td>
                            <td width="11%" bgcolor="#FFFFFF">
                                <div align="center" class="text-sm text-sm">
                            ...
                            <td width="15%" bgcolor="#FFFFFF">
                                <div align="center" class="text-sm text-sm"><strong>| Rent
                                        {{ $index + 1 }}/{{ $agreement->agreement_payment->installment->installment_name }}</strong>
                                </div>
                            </td>
                        </tr>
                    @endforeach
