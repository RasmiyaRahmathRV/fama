<div class="card card-outline card-info">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fas fa-file-invoice-dollar"></i> Investment Details
        </h3>
    </div>
...
<div class="card card-outline card-info">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fas fa-file-invoice-dollar"></i> Nominee Details
        </h3>
    </div>
...
<div class="card card-outline card-info">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fas fa-file-alt"></i> Investment Document
        </h3>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            @if (!empty($document->investment_contract_file_path))
                                ...
                                <a href="{{ asset('storage/' . $document->investment_contract_file_path) }}" download
